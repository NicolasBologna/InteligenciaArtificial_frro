...
abrir_base :- retractall(nino/3), retractall(vacuna_edad/3), retractall(vacuna/2), consult('C:/Users/Agus/Desktop/Inteligencia Artificial/Guada Info/Prolog/Finales_Agu/BC/BC_IAA_Final_2018_03_08.txt').